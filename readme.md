...
- Fast data I/O  
- Low latency network for multi-GPU sync  
...
- Optimized runtimes  
- High throughput serving systems  
- Possibly edge or cloud-based deployment  
...
### 4.1 Training Infrastructure:
- Must handle gigantic datasets  
- Requires distributed compute, high-speed networks, scalable storage  
- Monitoring and orchestration must handle many GPUs across nodes  

### 4.2 Inference Infrastructure:
- Must serve many requests reliably and quickly  
- Optimization of latency and cost is key  
- Deployment in production often involves high availability, efficiency, scalability  

In short: A system built for training is **not** automatically optimized for inference, and vice-versa. Infrastructure teams must design accordingly.
...
- Understand **what changes between training and inference** (objectives, resources, optimization).  
- Know that **multi-GPU training** demands high bandwidth, low latency interconnects, and large storage throughput.  
- Know that **inference setups** require low latency, high availability, optimized runtimes, and possibly edge deployment.  
- Be familiar with terms:
  - **Epoch** (one full pass of data in training)  
  - **Batch size**  
...
> “Training is how models learn; inference is how they serve.”  
